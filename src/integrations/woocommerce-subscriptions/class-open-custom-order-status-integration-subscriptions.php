...
namespace OpenCustomOrderStatus\Integration;
...
class Subscriptions {
	 ...
	 *
	 * @see \OpenCustomOrderStatus\Integration\Subscriptions::ensure_on_hold_in_valid_statuses()
	 *
	 * @since 1.13.3
	 *
	 * @internal
	 ...
	 *
	 * @see \OpenCustomOrderStatus\Integration\Subscriptions::attach_ensure_on_hold_in_valid_statuses()
	 *
	 * @internal
	 *
	 * @since 1.13.3

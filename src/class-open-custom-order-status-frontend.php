...
/**
 * Open Custom Order Status Frontend
 *
 * @since 1.0.0
 */
class Open_Custom_Order_Status_Frontend {
	...
	*/
	 ...
	 *
	 * @since 1.3.0
	 * @param \Open_Custom_Order_Status_Order_Status $order_status
	...
	private function render_order_status_description_tooltip( $order_status, $selector = 'order-status' ) {
		...
		if ( $order_status instanceof Open_Custom_Order_Status_Order_Status && $description = $order_status->get_description() ) {
